...
pub struct EnglishData();

impl NgramData for EnglishData {
    ...
    fn get_bigrams(&self) -> Vec<String> {
        [
            ...
            "et", "ut", "ss", "so", "rs", "un", "lo", "wa", "ge", "ie", "wh", "ee", "wi", "em",
            "ad", "ol", "rt", "po", "we", "na", "ul", "ni", "ts", "mo", "ow", "pa", "im", "mi",
            "ai", "sh", "ir", "su", "id", "os", "iv", "ia", "am", "fi", "ci", "vi", "pl", "ig",
            "tu", "ev", "ld", "ry", "mp", "fe", "bl", "ab", "gh", "ty", "op", "wo", "sa", "ay",
            "ex", "ke", "fr", "oo", "av", "ag", "if", "ap", "gr", "od", "bo", "sp", "rd", "do",
            "uc", "bu", "ei", "ov", "by", "rm", "ep", "tt", "oc", "fa", "ef", "cu", "rn", "sc",
            "gi", "da", "yo", "cr", "cl", "du", "ga", "qu", "ue", "ff", "ba", "ey", "ls", "va",
            "um", "pp", "ua", "up", "lu", "go", "ht", "ru", "ug", "ds", "lt", "pi", "rc", "rr",
            "eg", "au", "ck", "ew", "mu", "br", "bi", "pt", "ak", "pu", "ui", "rg", "ib", "tl",
            "ny", "ki", "rk", "ys",
        ]
        .into_iter()
        .map(String::from)
    ...
    fn get_trigrams(&self) -> Vec<String> {
        [
            ...
            "iti", "rat", "nte", "tin", "ine", "der", "ome", "man", "pre", "rom", "tra", "whi",
            "ave", "str", "act", "ill", "ure", "ide", "ove", "cal", "ble", "out", "sti", "tic",
            "oun", "enc", "ore", "ant", "ity", "fro", "art", "tur", "par", "red", "oth", "eri",
            "hic", "ies", "ste", "ght", "ich", "igh", "und", "you", "ort", "era", "wer", "nti",
            "oul", "nde", "ind", "tho", "hou", "nal", "but", "hav", "uld", "use", "han", "hin",
            "een", "ces", "cou", "lat", "tor", "ese", "age", "ame", "rin", "anc", "ten", "hen",
            "min", "eas", "can", "lit", "cha", "ous", "eat", "end", "ssi", "ial", "les", "ren",
            "tiv", "nts", "whe", "tat", "abl", "dis", "ran", "wor", "rou", "lin", "had", "sed",
            "ont", "ple", "ugh", "inc", "sio", "din", "ral", "ust", "tan", "nat", "ins", "ass",
            "pla", "ven", "ell", "she", "ose", "ite", "lly", "rec", "lan", "ard", "hey", "rie",
            "pos", "eme", "mor", "den", "oug", "tte", "ned", "rit", "ime", "sin", "ast", "any",
            "orm", "ndi", "ona", "spe", "ene", "hei", "ric", "ice", "ord", "omp", "nes", "sen",
            "tim", "tri", "ern", "tes", "por", "app", "lar", "ntr",
        ]
        .into_iter()
        .map(String::from)
        .collect()
    ...
    fn get_tetragrams(&self) -> Vec<String> {
        [
            "tion", "atio", "that", "ther", "with", "ment", "ions", "this", "here", "from", "ould",
            "ting", "hich", "whic", "ctio", "ence", "have", "othe", "ight", "sion", "ever", "ical",
            "they", "inte", "ough", "ance", "were", "tive", "over", "ding", "pres", "nter", "comp",
            "able", "heir", "thei", "ally", "ated", "ring", "ture", "cont", "ents", "cons", "rati",
            "thin", "part", "form", "ning", "ecti", "some", "port", "enti", "onal", "itio", "hing",
            "ound", "will", "reat", "comm", "nder", "time", "emen", "iona", "more", "stat", "stan",
            "king", "been", "ress", "thou", "when", "acti", "lati", "them", "spec", "very", "side",
            "thes", "woul", "tain", "nati", "rate", "cent", "ount", "rese", "sing", "what", "tate",
            "even", "work", "unde", "mber", "hese", "cial", "than", "eral", "ater", "tter", "sent",
            "fore", "ract", "ling", "cess", "inst", "erat", "coun", "ange", "ties", "cati", "late",
            "mple", "into", "each", "dent", "serv", "only", "abou", "tati", "reas", "ious", "ssio",
            "most", "esti", "ness", "ctiv", "lity", "icat", "ster", "ered", "fere", "ates", "lect",
            "such", "arti", "indi", "ffer", "stra", "ings", "bout", "rent", "eren", "atte", "ener",
            "atur", "roug", "land", "come", "soci", "know", "also", "llow", "rest", "vers", "chan",
            "ativ", "ving", "ined", "call", "pers", "essi", "efor", "like", "gene", "diff", "self",
            "ause", "prov", "ries", "ilit", "ffic", "iden", "stor", "evel", "peri", "then", "long",
            "cond", "fect", "caus", "rica", "hose", "year", "utio", "esen", "ject", "rodu", "houg",
            "thro", "oduc", "irst", "cted", "afte", "tern", "conc", "fter", "firs", "tabl", "char",
            "once", "enta",
        ]
        .into_iter()
        .map(String::from)
